...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(444422404400000000);
...
const char     CRYPTONOTE_NAME[]                             = "aardocoin";
...
const int      P2P_DEFAULT_PORT                              = 14241;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 17671;
